...
function gotMessageFromServer(message) {
  ...
  if (typeof signal.displayName != 'undefined') {
    ...
    vidContainer.setAttribute('id',  peerUuid);
    vidContainer.appendChild(makeButton(signal.displayName));
    document.getElementById('users').appendChild(vidContainer);
  }
...
function makeButton(label) {
  var vidLabel = document.createElement('button');
  vidLabel.appendChild(document.createTextNode(label));
  vidLabel.setAttribute('class', 'btn btn-primary');
